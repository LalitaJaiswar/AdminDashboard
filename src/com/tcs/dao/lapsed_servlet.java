...
/**
 * Servlet implementation class lapsed_servlet
 */
@WebServlet("/lapsed_servlet")
public class lapsed_servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cn==null) {
			...
			out.println("location='lapsed_ticket.jsp';");
			out.println("</script>");
			return;
		}
		try {
